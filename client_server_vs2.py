        ...
        try:
            while self.running:
                ...
                if msg['type'] == 'REGISTER':
                    client_id = self._create_client_id(msg['public_ip'], msg['udp_port'])
                    self.peers[conn] = {"ip": msg['public_ip'], "port": msg['udp_port'], "id": client_id}
...
class P2PClient:
    ...
    def start(self):
        ...
        reg = {"type": "REGISTER", "public_ip": my_ip, "udp_port": self.udp_port}
